...
export class SearchPage {
    ...
    constructor(public loadingCtrl: LoadingController, public afDB: AngularFireDatabase, public db: DatabaseProvider, public navCtrl: NavController) {
      ...
      db.getAllCollections('contact')
          .then(function (e) {
              if (!!e) {
                  console.log(e);
                  that.contact = <FirebaseListObservable<any>>Observable.of(e);
                  that.contactArray = e;
