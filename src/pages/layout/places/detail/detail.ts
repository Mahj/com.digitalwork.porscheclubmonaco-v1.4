...
export class CityDetailPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public modalCtrl: ModalController, public afDB: AngularFireDatabase, private toastCtrl: ToastController,
